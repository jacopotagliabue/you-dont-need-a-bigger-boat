...
if __name__ == '__main__':
    ...
    # for now, upload 1000 rows
    # there is no versioning whatsoever at this stage
    upload_file_as_parquet(SKU_TO_CONTENT_PATH, TARGET_S3_PATH, chunksize=1000)
    upload_file_as_parquet(BROWSING_TRAIN_PATH, TARGET_S3_PATH, chunksize=1000)
    upload_file_as_parquet(SEARCH_TRAIN_PATH, TARGET_S3_PATH, chunksize=1000)
